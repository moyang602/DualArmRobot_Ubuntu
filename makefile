...
control.o:	control.c trajectory.h
	gcc -c -I/usr/xenomai/include -D_GNU_SOURCE -D_REENTRANT -D__XENO__  control.c trajectory.h -Xlinker -rpath -Xlinker /usr/xenomai/lib -lnative -L/usr/xenomai/lib -lxenomai -lpthread -lrtdm -lrt -lX11 -lm
